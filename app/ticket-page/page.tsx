        ...
        <header className="flex items-center justify-between whitespace-nowrap border-b border-white/10 px-6 py-4 lg:px-10 bg-[#191022]/80 backdrop-blur-md sticky top-0 z-50">
          ...
          <div className="flex flex-1 justify-end gap-4 lg:gap-8 items-center">
            <div className="hidden md:flex items-center gap-6 lg:gap-9">
              <Link href="/" className="text-slate-300 hover:text-white transition-colors text-sm font-medium leading-normal">Line-up</Link>
              <Link href="/tickets" className="text-slate-300 hover:text-white transition-colors text-sm font-medium leading-normal">Bilete</Link>
